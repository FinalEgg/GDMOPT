...
def main(args=get_args()):
    # create environments，参考 train_GDM-DRL.py 修改环境创建调用
    ...
    # 修改日志保存路径为 log/default/TD3，并添加时间戳, 保持与 train_GDM-DRL 的一致性
    ...
    if __name__ == '__main__':
        ...
        result = collector.collect(n_episode=1)  # 去除 render 参数，避免调用未实现的 render
