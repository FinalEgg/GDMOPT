...
def simulate_td3(model_path, interval=1.5, enable_layer_dist=True):
    ...
    # 加载模型权重
    actor = TD3Actor(state_dim, hidden_dim, action_dim, max_action=max_action, device=device)
...
if __name__ == "__main__":
    model_path = "log/default/TD3/model-42/policy.pth"  # 请替换为实际的TD3模型路径
