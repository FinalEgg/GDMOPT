...
class Diffusion(nn.Module):
    ...
    def p_mean_variance(self, x, t, s):
        # bouded_noise = torch.tanh(self.model(x, t, s)/self.expand)*6 #tanh edit
        bouded_noise = self.model(x, t, s)
        x_recon = self.predict_start_from_noise(x, t=t, noise=bouded_noise)
    ...
    def sample(self, state, *args, **kwargs):
        ...
        return torch.tanh(action/self.expand) * self.max_action #edited
        # return action
